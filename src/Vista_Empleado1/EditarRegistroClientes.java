 ...
 * @author User
 */
public class EditarRegistroClientes extends javax.swing.JFrame {

    /**
     * Creates new form AñadirRegistroClientes
     */
    public EditarRegistroClientes() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarRegistroClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditarRegistroClientes().setVisible(true);
            }
        });
    }
