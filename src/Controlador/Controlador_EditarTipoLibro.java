...
public class Controlador_EditarTipoLibro implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(vista.jtxtPorcentajeDescuentoEditar.getText().isEmpty()){
            vista.jtxtPorcentajeDescuentoEditar.setText("0.0");
        } else if (vista.jcbxDescuentoEditar.getSelectedIndex() == 0 && Double.parseDouble(vista.jtxtPorcentajeDescuentoEditar.getText()) <= 0) {
