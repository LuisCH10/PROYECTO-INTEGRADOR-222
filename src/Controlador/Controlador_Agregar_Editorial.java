...
public class Controlador_Agregar_Editorial implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if(vista.jtxtPorcentajeDescuento.getText().isEmpty()){
            vista.jtxtPorcentajeDescuento.setText("0.0");
        } else if (vista.jcbxDescuento.getSelectedIndex()==0 && Double.parseDouble(vista.jtxtPorcentajeDescuento.getText())<=0){
