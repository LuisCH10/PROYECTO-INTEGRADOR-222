...
public class Controlador_AgregarTipoLibro implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(vista.jtxtPorcentajeDescuentoTpl.getText().isEmpty()){
            vista.jtxtPorcentajeDescuentoTpl.setText("0.0");
        } else if (vista.jcbxDescuentoTpl.getSelectedIndex() == 0 && Double.parseDouble(vista.jtxtPorcentajeDescuentoTpl.getText()) <= 0) {
