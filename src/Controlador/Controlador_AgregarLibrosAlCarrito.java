        ...
        if (e.getSource() == vista.jbtnAgregar) {
            ...
            if (Integer.parseInt(vista.jspnCantidad.getValue().toString()) <= 0) {
                ...
                if (resultado == true) {
                    ...
                    double totalForma = Double.parseDouble(df.format(total));
                    modelo.addRow(lib.RegistroLibrosCarrito(id, titulo, autor, editorial, tipo, numpagina, precio, Integer.parseInt(vista.jspnCantidad.getValue().toString()), descuento, totalForma));
                    ...
                    vista2.jtxtCostoTotal.setText("S/. " + df.format(acumulado));
                    this.vista.dispose();
                }
            }
        }
